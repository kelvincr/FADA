...
def test_model(encoder, classifier):
    ...
    data_dir = '/home/villacis/villacis/datasets/plantclef20_split/photo/val'
        ...
        for f in os.listdir(source_dir):
            if (f.endswith('.jpg') or f.endswith('.JPG')):
                ...
                with torch.no_grad():
                    primero = True
                    observacion = 0
                    for i in range(test_data_augmentation):
                        imagen = test_transforms(imagen2)
                        ...
                        if(primero):
                            ...
                            observacion += outputs
                    mrr += get_rank(observacion, label.item())
                    queries += 1
