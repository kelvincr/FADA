...
class ClassifierPro(BasicModule):
    ...
    def __init__(self):
        ...
        self.fc0=nn.Linear(2048, 998) #para r50 e inception
...
class ClassifierProCustom(BasicModule):

    def __init__(self, output):
        super(ClassifierProCustom, self).__init__()
        self.name = 'result/classifierpro_r18.pth'
        #self.fc0=nn.Linear(2048,1024) #para r50 e inception
        #self.fc1=nn.Linear(1024,512)  #para r50 e inception
        self.fc2=nn.Linear(512,120)
        self.fc3=nn.Linear(120,output)
